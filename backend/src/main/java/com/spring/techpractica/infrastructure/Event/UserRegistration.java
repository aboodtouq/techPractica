...
public class UserRegistration {
    ...
    public void handleUserRegistrationEvent(UserRegistrationEvent event) throws MessagingException {
        ...
        String token = jwtGeneration.generateToken(event.userId(), event.email());

        String htmlContent = getHtmlContent(event, token);
    ...
    private static String getHtmlContent(UserRegistrationEvent event, String token) {
