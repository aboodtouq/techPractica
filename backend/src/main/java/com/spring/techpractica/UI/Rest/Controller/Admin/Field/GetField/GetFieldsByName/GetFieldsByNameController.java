...
public class GetFieldsByNameController {
   ...
   // @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<?> getSystems(@RequestBody @Validated GetFieldsByNameRequest request) {
        try {
            List<Field> fields = getFieldsByNameUseCase.execute(new GetFieldsByNameCommand(request.names()));

            List<FieldResources> responseDataList = new FieldCollection(fields).getFields();
