    ...
    <>
      <div className="border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-xs bg-[#42D5AE]/10 text-[#022639] border border-[#42D5AE] rounded-full px-2 py-0.5 cursor-pointer">
            {categoryName}
          </span>
        </div>
        <p
          className="text-sm text-gray-700 leading-relaxed mb-4  break-words"
